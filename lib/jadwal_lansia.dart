...
import 'package:myapp/model/lansia_model.dart'; // Pastikan file ini ada
import 'package:myapp/service/imunisasi_service.dart'; // Pastikan file ini ada

class JadwalLansia extends StatefulWidget {
  @override
  _JadwalLansiaState createState() => _JadwalLansiaState();
}

class _JadwalLansiaState extends State<JadwalLansia> {
  ...
  void _validateAndSubmit() async {
    try {
      if (_dateController.text.isNotEmpty) {
        ...
        await _imunisasiService.addLansia(lansia);

        // Siapkan pesan notifikasi
        String notifMessage = 'Pendaftaran imunisasi berhasil disimpan:\n'
            'Nama: ${lansia.nama}\n'
            'Alamat: ${lansia.alamat}\n'
            'Tanggal Imunisasi: ${_dateFormat.format(lansia.tanggalImunisasi)}';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Jadwal Lansia'),
